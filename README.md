...
Сайт ironau.ru содержит большое количество текстов на осетинском языке, в том числе статьи по истории, культуре и литературе, которые могут быть использованы для создания корпуса. Однако, тексты на сайте не представлены в машиночитаемом виде, что затрудняет их использование для анализа и обработки.
